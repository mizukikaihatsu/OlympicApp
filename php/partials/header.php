            ...
            <header class="container my-2">
                <nav class="row align-items-center py-2">
                    <a href="<?php the_url('/'); ?>" class="col-md d-flex align-items-center mb-3 mb-md-0">
                        <img width="50" class="mr-2" src="<?php echo BASE_IMAGE_PATH; ?>logo.svg" alt="オリンピックメダル予想　サイトロゴ">
                        <span class="h2 font-weight-bold mb-0">オリンピックメダル予想</span>
                    </a>
